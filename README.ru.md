...
2. Скачайте и запустите **Coding Time Tracker for Steam**. [Ссылка на скачивание]
...
- **[GitHub](https://github.com/)**: Исходный код и описание проекта.
- **[Страница разработчика в Steam](#)**: Последние обновления и проекты.
