...
1. Скачайте файлы проекта с [репозитория GitHub](https://github.com/).
...
- **[Страница разработчика на GitHub](https://github.com/Chelovedus/Coding-Time-Tracker-For-Steam/archive/refs/tags/Release.zip)**: Исходный код и описание проекта.
- **[Страница разработчика в Steam](https://steamcommunity.com/id/superfrost/)**: Последние обновления и проекты.
